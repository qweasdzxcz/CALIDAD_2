...
public class BusquedaProductoSalida extends javax.swing.JDialog {
...
//        Controlador_NuevaVenta cnv = new Controlador_NuevaVenta(p, this);
    ...
    public BusquedaProductoSalida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaProductoSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BusquedaProductoSalida dialog = new BusquedaProductoSalida(new javax.swing.JFrame(), true);
